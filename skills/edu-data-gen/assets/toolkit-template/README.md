...
```
content_list.json   要生成的内容点清单（id/类型/年级×Bloom/种子/模板）
...
## 5. 多文件输出
每个内容点在 `output/<id>/` 下按 `config.file_split.by_field_group` 切成多个文件
