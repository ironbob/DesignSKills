...
| `learning` | 学习心流页 | level3；主区只放学习内容；引导进入 `assistive_elements` |
...
以下样例故意保持最小但完整：所有 target 都能解析，所有示例值都引用 `sample_state`，所有 zone.kind 都在闭环枚举内。每个可见元素都带 `element_contract`；学新页的“学习引导”在 `assistive_elements`，不占主内容区。
  ...
  "pages": [
    {
      ...
      "primary_action": {
        ...
        "element_contract": { "intent": "primary_action", "surface": "action_bar", "priority": "primary", "persistence": "contextual", "blocking": false }
      },
      "secondary_actions": [
        { "label": "浏览课程", "target": "course_list", "behavior": null, "icon": "grid", "placement": "inline", "element_contract": { "intent": "secondary_action", "surface": "inline", "priority": "secondary", "persistence": "contextual", "blocking": false } }
      ],
      ...
      "density": {
        "button_count": 4,
        "zones": [
          { "id": "today_status", "kind": "badge_strip", "label": "今日", "element_contract": { "intent": "status", "surface": "badge", "priority": "low", "persistence": "always", "blocking": false } },
          { "id": "continue_learning", "kind": "hero_card", "label": "继续学习", "element_contract": { "intent": "learn_content", "surface": "main_content", "priority": "primary", "persistence": "contextual", "blocking": false } },
          { "id": "quick_entries", "kind": "quick_entries", "label": "快捷入口", "element_contract": { "intent": "secondary_action", "surface": "inline", "priority": "secondary", "persistence": "contextual", "blocking": false } }
        ]
      },
      "assistive_elements": [],
      "jumps": [
    ...
    },
    {
      ...
      "density": {
        "button_count": 2,
        "zones": [
          { "id": "courses", "kind": "row_list", "label": "课程", "element_contract": { "intent": "learn_content", "surface": "main_content", "priority": "primary", "persistence": "always", "blocking": false } }
        ]
      },
      "assistive_elements": [],
      "jumps": [
        { "trigger": "点击课程行", "from": "courses", "target": "course_detail", "reversible": true }
      ]
    },
    {
      "id": "course_detail",
      ...
      "secondary_actions": [
        ...
        { "label": "分享", "target": null, "behavior": "share", "icon": "share", "placement": "action_bar", "element_contract": { "intent": "secondary_action", "surface": "action_bar", "priority": "low", "persistence": "user_invoked", "blocking": false } }
      ],
      ...
      "density": {
        "button_count": 4,
        "zones": [
          { "id": "course_progress", "kind": "progress_strip", "label": "进度", "element_contract": { "intent": "status", "surface": "inline", "priority": "secondary", "persistence": "always", "blocking": false } },
          { "id": "chapters", "kind": "chapter_tree", "label": "章节", "element_contract": { "intent": "learn_content", "surface": "main_content", "priority": "primary", "persistence": "always", "blocking": false } }
        ]
      },
      "assistive_elements": [],
      "jumps": [
    ...
    },
    {
      ...
      "secondary_actions": [
        ...
        { "label": "目录", "target": "chapter_drawer", "behavior": null, "icon": "list", "placement": "action_bar", "element_contract": { "intent": "navigation", "surface": "action_bar", "priority": "secondary", "persistence": "user_invoked", "blocking": false } },
        { "label": "发音", "target": null, "behavior": "play_audio", "icon": "volume", "placement": "inline", "element_contract": { "intent": "secondary_action", "surface": "inline", "priority": "secondary", "persistence": "contextual", "blocking": false } }
      ],
      ...
      "density": {
        "button_count": 5,
        "zones": [
          { "id": "word", "kind": "word_card", "label": "学习项", "element_contract": { "intent": "learn_content", "surface": "main_content", "priority": "primary", "persistence": "always", "blocking": false } }
        ]
      },
      "assistive_elements": [
        { "id": "learning_guidance", "kind": "hint_block", "label": "学习引导", "trigger": "first_enter", "target": null, "element_contract": { "intent": "guidance", "surface": "coachmark", "priority": "low", "persistence": "first_time_only", "blocking": false } }
      ],
      "jumps": [
    ...
    },
    {
      ...
      "density": {
        "button_count": 5,
        "zones": [
          { "id": "question", "kind": "option_list", "label": "练习题", "element_contract": { "intent": "input", "surface": "main_content", "priority": "primary", "persistence": "always", "blocking": false } }
        ]
      },
      "assistive_elements": [],
      "jumps": [
    ...
    },
    {
      ...
      "secondary_actions": [
        ...
        { "label": "返回课程", "target": "course_detail", "behavior": null, "icon": "back", "placement": "action_bar", "element_contract": { "intent": "navigation", "surface": "action_bar", "priority": "low", "persistence": "user_invoked", "blocking": false } }
      ],
      ...
      "density": {
        "button_count": 3,
        "zones": [
          { "id": "score", "kind": "score_ring", "label": "成绩", "element_contract": { "intent": "feedback", "surface": "inline", "priority": "primary", "persistence": "always", "blocking": false } },
          { "id": "mastery", "kind": "mastery_bar", "label": "掌握情况", "element_contract": { "intent": "status", "surface": "inline", "priority": "secondary", "persistence": "always", "blocking": false } }
        ]
      },
      "assistive_elements": [],
      "jumps": [
    ...
    },
    {
      ...
      "density": {
        "button_count": 4,
        "zones": [
          { "id": "stats", "kind": "stat_grid", "label": "统计", "element_contract": { "intent": "status", "surface": "inline", "priority": "primary", "persistence": "always", "blocking": false } },
          { "id": "links", "kind": "row_list", "label": "入口", "element_contract": { "intent": "navigation", "surface": "menu", "priority": "secondary", "persistence": "always", "blocking": false } }
        ]
      },
      "assistive_elements": [],
      "jumps": [
    ...
    },
    {
      ...
      "density": {
        "button_count": 1,
        "zones": [
          { "id": "report", "kind": "stat_grid", "label": "学习报告", "element_contract": { "intent": "status", "surface": "inline", "priority": "primary", "persistence": "always", "blocking": false } }
        ]
      },
      "assistive_elements": [],
      "jumps": [
        { "trigger": "点击返回我的", "from": "action_bar", "target": "profile", "reversible": true }
      ]
    },
    {
      "id": "note_modal",
      ...
      "density": {
        "button_count": 1,
        "zones": [
          { "id": "note_body", "kind": "text_block", "label": "笔记", "element_contract": { "intent": "learn_content", "surface": "main_content", "priority": "primary", "persistence": "contextual", "blocking": false } }
        ]
      },
      "assistive_elements": [],
      "jumps": [
        { "trigger": "点击关闭", "from": "modal", "target": "learning_page", "reversible": true }
      ]
    },
    {
      "id": "chapter_drawer",
      ...
      "density": {
        "button_count": 2,
        "zones": [
          { "id": "chapter_list", "kind": "chapter_tree", "label": "目录", "element_contract": { "intent": "navigation", "surface": "menu", "priority": "primary", "persistence": "user_invoked", "blocking": false } }
        ]
      },
      "assistive_elements": [],
      "jumps": [
    ...
    },
    {
      ...
      "density": {
        "button_count": 1,
        "zones": [
          { "id": "hint_text", "kind": "hint_block", "label": "提示", "element_contract": { "intent": "guidance", "surface": "modal", "priority": "low", "persistence": "user_invoked", "blocking": true } }
        ]
      },
      "assistive_elements": [],
      "jumps": [
        { "trigger": "点击关闭", "from": "modal", "target": "quiz_page", "reversible": true }
      ]
    }
  ]
}
